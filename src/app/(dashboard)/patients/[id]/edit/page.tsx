    ...
    return (
      <div className="p-6">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">The patient you're trying to edit doesn't exist.</p>
    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-gray-600">Update patient information and emergency contact details</p>
        </div>
      </div>
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Enter any relevant medical conditions, allergies, medications, etc."
                rows={4}
              />
              <p className="text-sm text-gray-500">
                Include any chronic conditions, allergies, current medications, or other relevant medical information.
              </p>
            </div>
          </CardContent>
        </Card>
